...
// Package resourcestore is a generated GoMock package.
...
func (m *MockResourceStore) List(owner string, resources interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", owner, resources)
	ret0, _ := ret[0].(error)
	return ret0
}

// List indicates an expected call of List
func (mr *MockResourceStoreMockRecorder) List(owner, resources interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockResourceStore)(nil).List), owner, resources)
}
