...
func NewBareMetalHostRepository(bmh *models.BareMetalHost) *BareMetalHostRepository {
	b := &BareMetalHostRepository{bmh}
...
func (b *BareMetalHostRepository) Save() error {
